...
REM
REM Generated by Vivado on Wed Dec 10 22:29:16 -0500 2025
...
echo "xvlog --incr --relax -prj pcm_to_dsd_tb_vlog.prj"
call xvlog  --incr --relax -prj pcm_to_dsd_tb_vlog.prj -log xvlog.log
